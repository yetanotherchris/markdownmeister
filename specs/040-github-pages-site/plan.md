...
**Testing**: `tests/main/siteContract.test.ts` (Vitest node project) fs-reads the site sources and workflow, asserting FR-002/003/005/006/008/009 shapes: required elements, exact navigation targets, no externally loaded resources, workflow wiring. Visual/responsive/appearance checks are manual per [quickstart.md](quickstart.md).
