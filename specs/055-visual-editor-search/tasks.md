...
## Phase 2: Plugin and panel (R2, FR-001/003/004/005/006/008)
...
- [ ] 3.1 Add the find shortcut (Ctrl/Cmd+F) to `src/main/shortcuts.ts` and a Find entry showing it to `src/main/menuModel.ts`; extend `tests/main/shortcuts.test.ts`
