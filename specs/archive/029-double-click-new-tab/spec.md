...
- **2026-09-06 (RE-AMENDMENT — deferral restored)**: The user reported the double-click "open in a new tab" behaviour as broken and confirmed the intent: double-clicking a file MUST always open it in a NEW tab, leaving the active tab — clean or dirty — untouched. The 2026-08-21 amendment is reverted for the clean-tab case: the single-click deferral by `DOUBLE_CLICK_WINDOW_MS` is restored so a double-click is again one gesture (FR-003), and its explicit-new request opens a new tab rather than deduping onto a replaced one. FR-001/SC-001 (new tab, active tab untouched) hold again; FR-002/005/007/008/009 hold as before; the same-tab single-click that replaces a clean tab regains the 500 ms deferral latency, accepted because it is the only way to recognise the double-click before the replace commits.
