...
| Context-menu instance | `CodeBracketSquareIcon` React component in `Tree.tsx` | "View source" menu item (US2 scenario 3) |
...
| View-source action inspected (either surface) | hover/inspect | code-bracket-square glyph in `--mm-view-source` dark blue, legible on light and dark (FR-004/005/006) |
