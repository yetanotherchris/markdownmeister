...
- **Supersession**: This feature partially supersedes the stored-context restore of the archived source-view specifications (002 and 044) in exactly the case FR-004 describes; every other guarantee of those specifications is restated here or left intact (FR-003, FR-009).
