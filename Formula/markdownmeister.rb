class Markdownmeister < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/yetanotherchris/markdownmeister/releases/download/v0.1.0/markdownmeister-0.1.0-macos-arm64.zip"
      sha256 "0bf528d65b81d4346812c24c7e3f472227cc5005ab947b4839ac216e1d74036f"
    else
      url "https://github.com/yetanotherchris/markdownmeister/releases/download/v0.1.0/markdownmeister-0.1.0-macos-x64.zip"
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      url "https://github.com/yetanotherchris/markdownmeister/releases/download/v0.1.0/markdownmeister-0.1.0-linux-x64.AppImage"
